...
class BootStrap {
	...
	def init = { servletContext ->
		print Environment.getCurrent().equals("DEVELOPMENT") 
	...
	private void createData() {
		...
		description: 'This conference will bring coders from').save()
		...
		description: 'Join the Perl programmers of the Pork Producers').save()
		...
		g1.addToRespondents('tony@gmail.com')
		g1.addToRespondents('kevin@gmail.com')
		g1.save()
